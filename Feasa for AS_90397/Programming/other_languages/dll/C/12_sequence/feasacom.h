...
typedef int (__stdcall *tFeasaCom_DaisyChain_SpectrometerCapture)(const int CommPort, const int UsePresetExposure, const int UseCustomExposure, const float ExposureTime);
