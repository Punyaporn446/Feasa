...
typedef int(__stdcall *tFeasaCom_OpenSN_Multi)(int * ReturnValues, char ** SerialNumbers, int nPorts, char * Baudrate);
typedef int(__stdcall *tFeasaCom_CloseSN_Multi)(int * ReturnValues, char ** SerialNumbers, int nPorts);
...
typedef int(__stdcall *tFeasaCom_AreConnected)(char ** SerialNumbers, int nSerials, char * Baudrate, int * PortNumbers);
typedef int(__stdcall *tFeasaCom_AreConnectedS)(char * SerialNumbers, char * Baudrate, int * PortNumbers);
