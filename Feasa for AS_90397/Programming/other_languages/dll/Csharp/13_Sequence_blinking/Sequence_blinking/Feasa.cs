...
namespace FeasaLib
{
    class FeasaCom
    {
        private const string DLL_FEASACOM = "feasacom64.dll"; // Note: feasacom64.dll file has to be used for 64bit targets and feasacom.dll for 32bit targets
    ...
    {
        public const string DLL_FEASATOOLS = "feasa_tools64.dll"; // Note: feasa_tools64.dll file has to be used for 64bit targets and feasa_tools.dll for 32bit targets
