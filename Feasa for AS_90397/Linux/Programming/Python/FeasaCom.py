...
GetLibraryVersion = FeasaLIB['FeasaCom_GetLibraryVersion']
GetLibraryVersion.argtypes = [ctypes.c_char_p]
...
OpenProject = FeasaLIB['FeasaCom_OpenProject']
OpenProject.argtypes = [ctypes.c_char_p]
OpenProject.restype = ctypes.c_int

CloseProject = FeasaLIB['FeasaCom_CloseProject']
CloseProject.restype = ctypes.c_int

SendID = FeasaLIB['FeasaCom_SendByID']
SendID.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
SendID.restype = ctypes.c_int
...
SpectrometerDark = FeasaLIB['FeasaCom_SpectrometerDark']
SpectrometerDark.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_int, ctypes.c_float]
...
Sequence_ReadCCT = FeasaLIB['FeasaCom_Sequence_ReadCCT']
Sequence_ReadCCT.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_float)]
Sequence_ReadCCT.restype = ctypes.c_int

Sequence_ReadWavelength = FeasaLIB['FeasaCom_Sequence_ReadWavelength']
Sequence_ReadWavelength.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.POINTER(ctypes.c_int)]
...
DaisyChain_Send = FeasaLIB['FeasaCom_DaisyChain_Send']
DaisyChain_Send.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p]
...
DaisyChain_SpectrometerDark = FeasaLIB['FeasaCom_DaisyChain_SpectrometerDark']
DaisyChain_SpectrometerDark.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_int, ctypes.c_float]
...
ExternalTrigger_Enable = FeasaLIB['FeasaCom_ExternalTrigger_Enable']
ExternalTrigger_Enable.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_int, ctypes.c_char_p, ctypes.c_int, ctypes.c_int, ctypes.c_int]
ExternalTrigger_Enable.restype = ctypes.c_int

ExternalTrigger_Disable = FeasaLIB['FeasaCom_ExternalTrigger_Disable']
ExternalTrigger_Disable.argtypes = [ctypes.c_char_p, ctypes.c_int]
ExternalTrigger_Disable.restype = ctypes.c_int
...
SetResponseTimeoutAuto = FeasaLIB['FeasaCom_SetResponseTimeoutAuto']
SetResponseTimeoutAuto.argtypes = [ctypes.c_char_p, ctypes.c_int]
...
GetDeviceType = FeasaLIB['FeasaCom_GetDeviceType']
GetDeviceType.argtypes = [ctypes.c_char_p, ctypes.c_char_p]
...
GetError_DescriptionByPort = FeasaLIB['FeasaCom_GetError_DescriptionByPort']
GetError_DescriptionByPort.argtypes = [ctypes.c_char_p, ctypes.c_char_p]

GetError_DescriptionBySN = FeasaLIB['FeasaCom_GetError_DescriptionBySN']
...
GetPortByID = FeasaLIB['FeasaCom_GetPortByID']
GetPortByID.argtypes = [ctypes.c_char_p, ctypes.c_char_p]
