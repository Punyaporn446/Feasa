namespace capture_and_read
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Label2.Text = "The Feasa Library functions are declared Form1.cs file. CAUTION: the SO file should be loc" +
                "ated in the system/lib folder or equivalent, with its permissions guaranteed.";
            // 
            // Label1
            // 
